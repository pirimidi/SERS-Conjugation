...
% INPUT ARGUMENTS:
%
%   - 'scale_factor' = any number to be used to scale every matrix entry 
%   - 'minima' = negative entries (after baseline substraction) will be
%                replaced with this number (usually 0 or 1)
%
% This software may be used, modified, and distributed freely, but this
% header may not be modified and must appear at the top of this file.
%--------------------------------------------------------------------------

function raman_matrix(scale_factor, minima)
...
for i=1:l
    ...
    % Normalize matrix entries according to differences in the two
    % calibration curves (DBCO-PEG4-Maleimide, N3-PEG4-Maleimide).
    M = M * scale_factor;
